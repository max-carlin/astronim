...
import numpy as np
import random
from utils.tools import get_2d, Vec3
from utils.constants import DEPTH
...
class BlackHole: 
    def __init__(self, obj_pos_2d, screen, color, obj_pos_3d):
        ...
        self.draw_bh(screen, color, obj_pos_2d)
    ...
    def draw_bh(self, screen, color, obj_pos_2d): 

        dx = self.obj_pos_3d.x - BlackHole.camera.x
        dy = self.obj_pos_3d.y - BlackHole.camera.y
        dz = self.obj_pos_3d.z - BlackHole.camera.z
